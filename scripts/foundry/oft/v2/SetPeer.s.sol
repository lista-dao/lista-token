 ...
 *         Must be broadcast by a DEFAULT_ADMIN_ROLE holder (setPeer is the
 *         cross-chain trust anchor and is admin-gated).
 *
 * Env:
 *   DEPLOYER_PRIVATE_KEY (required, must hold DEFAULT_ADMIN_ROLE)
