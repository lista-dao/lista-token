...
contract PancakeStakingDistributorTest is Test {
  ...
  IPancakeStableSwapTwoPool pancakeStableSwapTwoPool =
    IPancakeStableSwapTwoPool(0xb1Da7D2C257c5700612BdE35C8d7187dc80d79f1);

  ERC20LpListaDistributor lisUSDUSDTPancakeStablePoolDistributor =
    ERC20LpListaDistributor(0xe8f4644637f127aFf11F9492F41269eB5e8b8dD2);
  ...
  function test_uppgrade() public {
    ITransparentUpgradeableProxy pancakeStakingProxy = ITransparentUpgradeableProxy(
      0xE31f0BcE1F825A8e27f2Cc30B54af19DA2978f10
    );
